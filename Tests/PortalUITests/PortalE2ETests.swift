...
final class PortalE2ETests: XCTestCase {

    private var gatewayURL: String {
        ProcessInfo.processInfo.environment["PORTAL_GATEWAY_URL"] ?? "ws://127.0.0.1:18642/v1/ws"
    }

    private var apiKey: String? {
        ProcessInfo.processInfo.environment["PORTAL_API_KEY"]
