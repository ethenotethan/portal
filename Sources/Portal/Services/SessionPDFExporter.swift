...
// ExportTableView and ExportCodeText moved to ExportPrimitives.swift — they are
// pure SwiftUI and must compile on iOS too (ArtifactExporter uses them on both
// platforms). ExportImageRow stays here: it needs NSImage.
