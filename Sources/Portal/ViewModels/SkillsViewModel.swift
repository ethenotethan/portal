...
internal final class SkillsViewModel {
    /// Skills to render, read from the WebSocket harness `SkillStore`.
    internal var skills: [SkillInfo] { SkillStore.shared.skills }
    internal var isLoading: Bool {
        SkillStore.shared.isLoading || SkillStore.shared.isPreFetching
    }
    internal var errorMessage: String? { SkillStore.shared.errorMessage }
