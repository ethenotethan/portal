...
private func loadLottieAnimation(fileName: String) -> LottieAnimation? {
    ...
    let possiblePaths = [
        buildDir.appendingPathComponent("../Sources/Portal/Resources/Lottie/\(fileName).json"),
        buildDir.appendingPathComponent("../../Sources/Portal/Resources/Lottie/\(fileName).json"),
        // Also try the SPM resource bundle sitting next to the exe
        buildDir.appendingPathComponent("Portal_Portal.bundle/Lottie/\(fileName).json"),
    ]
    ...
    let cwdPath = "\(cwd)/Sources/Portal/Resources/Lottie/\(fileName).json"
