...
let perfLog = Logger(subsystem: "com.ethenotethan.Portal", category: "perf")
...
enum PerfSignposter {
    static let shared = OSSignposter(subsystem: "com.ethenotethan.Portal", category: "perf-intervals")
